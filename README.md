...
<p align="center">
    ...
    <a href="https://github.com/MasterALiReza/WeBot" target="_blank">
        <img src="https://img.shields.io/github/stars/MasterALiReza/WeBot?style=social" alt="GitHub Stars"/>
    </a>
    <a href="https://img.shields.io/github/forks/MasterALiReza/WeBot?style=flat-square" target="_blank">
        <img src="https://img.shields.io/github/forks/MasterALiReza/WeBot?style=flat-square" alt="GitHub Forks"/>
    </a>
    <a href="https://github.com/MasterALiReza/WeBot/issues" target="_blank">
        <img src="https://img.shields.io/github/issues/MasterALiReza/WeBot?style=flat-square" alt="GitHub Issues"/>
    </a>
</p>
...
**WeBot Panel** is a feature-rich Telegram bot designed for selling VPN services for platforms like **Marzban** and **3x-ui panels**. This bot simplifies the process of VPN subscription sales, enabling seamless automation, configuration building, and user management.

WeBot Panel comes in two versions:
...
```bash
curl -o install.sh -L https://raw.githubusercontent.com/MasterALiReza/WeBot/main/install.sh && bash install.sh
```
...
```bash
curl -o install.sh -L https://raw.githubusercontent.com/MasterALiReza/WeBot/main/install.sh && bash install.sh -beta
```
...
```bash
curl -o install.sh -L https://raw.githubusercontent.com/MasterALiReza/WeBot/main/install.sh && bash install.sh -update
```
...
Want to see WeBot Panel in action? Try the demo bot here:
...
If you find **WeBot Panel** helpful and would like to support its development, you can make a financial contribution via cryptocurrency.
...
![Contributors](https://contrib.rocks/image?repo=MasterALiReza/WeBot)
