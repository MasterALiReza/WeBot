...
if(!file_exists($configDirectory) || !file_exists($tablesDirectory)) {
    ...
    $ERROR[] = "فایل های پروژه را مجددا دانلود و بارگذاری کنید (<a href='https://github.com/MasterALiReza/WeBot'>‎🌐 Github</a>)";
}
if(phpversion() < 8.2){
...
<body>
    <div class="container">
        ...
        <footer>
            <p>WeBot Installer , Made by ♥️ | <a href="https://github.com/MasterALiReza/WeBot">Github</a> | <a href="https://t.me/mirzapanel">Telegram</a> | &copy; <?php echo date('Y'); ?></p>
        </footer>
    </div>
</body>
</html>
